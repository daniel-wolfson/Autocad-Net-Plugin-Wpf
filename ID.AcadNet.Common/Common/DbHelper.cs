    ...
    public static class DbHelper
    {
        ...
        public static string[] GetSymbolTableRecordNames(ObjectId symbolTableId)
        {
            return
                ...
                .XOpenForRead<SymbolTableRecord>()
        ...
        public static ObjectId GetSymbolTableRecord(ObjectId symbolTableId, string name,
            ObjectId? defaultValue = null, Func<SymbolTableRecord> create = null)
        {
            using (var trans = symbolTableId.Database.TransactionManager.StartTransaction())
            {
                var table = (SymbolTable)trans.GetObject(symbolTableId, OpenMode.ForRead);
        ...
        {
            return GetSymbolTableRecords((db ?? HostApplicationServices.WorkingDatabase).LayerTableId);
        }
        ...
        {
            return GetSymbolTableRecordNames((db ?? HostApplicationServices.WorkingDatabase).LayerTableId);
        }
        ...
        public static void EnsureLayerOn(string layerName)
        {
            ...
            id.XOpenForWrite<LayerTableRecord>(layer =>
            {
        ...
        {
            return GetSymbolTableRecords((db ?? HostApplicationServices.WorkingDatabase).BlockTableId);
        }
        ...
        {
            return GetSymbolTableRecordNames((db ?? HostApplicationServices.WorkingDatabase).BlockTableId);
        }
        ...
        {
            var groupDict = entityId.Database.GroupDictionaryId.XOpenForRead<DBDictionary>();
            var entity = entityId.XOpenForRead<Entity>();
            try
            {
                return groupDict
                    .Cast<DBDictionaryEntry>()
                    .First(entry => entry.Value.XOpenForRead<Group>().Has(entity))
                    .Value;
            }
            catch
            {
        ...
        {
            var group = groupId.XOpenForRead<Group>();
            if (group != null)
            {
        ...
        public static Dictionary<string, ObjectId> GetBlockAttributeIds(this BlockReference blockReference)
        {
            ...
            foreach (ObjectId attrId in blockReference.AttributeCollection)
            {
                ...
                {
                    attrId.XOpenForWrite<AttributeReference>(attr =>
                    {
                ...
                {
                    var attr = attrId.XOpenForRead<AttributeReference>();
                    attrs.Add(attr.Tag, attrId);
        ...
        public static void DefineBlockAttribute(string blockName, string tag, string value, string prompt, Point3d position, ObjectId style)
        {
            ...
            {
                var block = trans.GetObject(GetBlockId(blockName), OpenMode.ForWrite) as BlockTableRecord;
        ...
        public static bool HasTag(this ObjectId id, string tag)
        {
            ...
            {
                var dbo = trans.GetObject(id, OpenMode.ForWrite);
                return dbo.HasTag(tag);
            }
        }
        ...
        {
            AffirmRegApp(db ?? HostApplicationServices.WorkingDatabase, new[]
            {
        ...
        internal static Database GetDatabase(ObjectId id)
        {
            return id.Database ?? HostApplicationServices.WorkingDatabase;
        }
    }
}
