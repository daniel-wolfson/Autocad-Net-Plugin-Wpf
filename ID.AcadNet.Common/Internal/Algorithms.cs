...
namespace Intellidesk.AcadNet.Common.Internal
{
    ...
    public static class Algorithms
    {
        ...
        {
            return curve.GetSubCurve(new Interv(interval.Item1, interval.Item2));
        }
        ...
        {
            return curve.GetSubCurveByParams(new Interv(interval.Item1, interval.Item2));
        }
        ...
        public static IEnumerable<Point3d> GetPolylineFitPoints(this Curve cv, int divsWhenArc = 0)
        {
            try
            {
                return cv.GetPolylineFitPointsImp(divsWhenArc).ToArray();
            }
            catch
            {
        ...
        {
            return entityIds.XOpenForRead<Entity>().GetExtents();
        }
        ...
        {
            return entId.XOpenForRead<Entity>().GeometricExtents.GetCenter();
        }
        ...
        {
            return polys.Aggregate(PolyJoin);
        }
        ...
        public static Polyline PolyJoinIgnoreMiddleVertices(this List<Polyline> polys) // newly 20130807
        {
            ...
            return DrawObject.Pline(points);
        }
        ...
        public static void IntersectWith3264(this Entity entity, Entity entOther, Intersect intersectType, Point3dCollection points)
        {
        ...
        {
            var points = new Point3dCollection();
            entity.IntersectWith3264(entOther, intersectType, points);
    ...
    public static class RegionLoopService
    {
        ...
        private static Polyline GetLoop(DBObjectCollection lines)
        {
            ...
            {
                var bulge = line is Arc ? (line as Arc).GetArcBulge(next) : 0;
    ...
    public class Interv
    {
        ...
        {
            return AddPoint(interval.Start).AddPoint(interval.End);
        }
