...
namespace Intellidesk.AcadNet.Common.CompBuilder
{
	/// <summary>
	...
	public class TransactionHelper : IDisposable
	{
		...
		TransactionHelper()
		{
            m_db = Autodesk.AutoCAD.ApplicationServices.Core.Application.DocumentManager.MdiActiveDocument.Database;
		}
        ...
        {
            ObjectId tblId = SymTbl.GetSymbolTableId(classType, m_db);
        ...
        AddNewSymbolRec(SymbolTableRecord newRec)
        {
            ...
            ObjectId tblId = SymTbl.GetSymbolTableId(newRec.GetType(), m_db);
