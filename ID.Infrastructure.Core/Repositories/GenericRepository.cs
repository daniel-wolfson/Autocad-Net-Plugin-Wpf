...
using ID.Infrastructure.Exrtensions;
...
namespace ID.Infrastructure.Repositories
{
    ...
    public class GenericRepository<TDbContext, TEntity, TKey> : IRepository<TDbContext, TEntity, TKey>
        where TEntity : class where TDbContext : IDbContext
    {
        ...
        public IDbContext DbContext
        {
            get
            {
                _dbContext = GeneralContext.GetService<IDbContext>();
                return _dbContext;
            }
            set
            {
        ...
        {
            var ents = ((DbContext)DbContext).GetTrackEntries<TEntity>().ToList();
            return ents;
        }
