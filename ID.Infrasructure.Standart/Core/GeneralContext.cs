...
namespace ID.Infrastructure.Core
{
    ...
    public static class GeneralContext
    {
        ...
        /// <summary> Get track entries/entities into current db context </summary>
        public static List<KeyValuePair<TEntity, EntityState>> GetTrackEntries<TEntity>(this DbContext dbContext) where TEntity : class
        {
