...
namespace AspNet.Identity.PostgreSQL
{
    ...
    public class PostgreSQLDatabase : IDisposable
    {
        ...
        public List<Dictionary<string, string>> Query(string commandText, Dictionary<string, object> parameters)
        {
            ...
            try
            {
                using (NpgsqlConnection conn = new NpgsqlConnection("Server=localhost; Port=5432; User Id=postgres; Password=123456; Database=postgres;"))
                {
                    conn.Open();
        ...
        private void OpenConnection()
        {
            ...
            {
                //_connection.TypeMapper.MapEnum<Permission>();
                //var mappings = _connection.TypeMapper.Mappings;
