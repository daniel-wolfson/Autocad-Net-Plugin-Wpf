...
namespace Intellidesk.AcadNet.Commands.Internal
{
    ...
    public static class Gui
    {
        ...
        public static void TextReport(string title, string content, double width, double height, bool modal = false)
        {
            ...
            if (modal)
            {
                Autodesk.AutoCAD.ApplicationServices.Core.Application.ShowModalWindow(tr);
            }
            else
            {
                Autodesk.AutoCAD.ApplicationServices.Core.Application.ShowModelessWindow(tr);
            }
        }
        ...
        public static void MultiInputs(string title, Dictionary<string, string> entries)
        {
            ...
            Autodesk.AutoCAD.ApplicationServices.Core.Application.ShowModalWindow(mi);
        }
        ...
        public static string InputBox(string tip, string defaultValue = "")
        {
            ...
            if (Autodesk.AutoCAD.ApplicationServices.Core.Application.ShowModalWindow(input) == true)
            {
                return input.Value;
            }
            return string.Empty;
        ...
        public static void ProgressIndicator(string title, BackgroundWorker worker)
        {
            ...
            Autodesk.AutoCAD.ApplicationServices.Core.Application.ShowModalWindow(tpw);
        }
