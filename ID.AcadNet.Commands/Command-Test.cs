...
using Intellidesk.AcadNet.Commands.Drawing;
using Intellidesk.AcadNet.Commands.GUIs;
    ...
    public class Commands2
    {
        ...
        public static void PolyClean3()
        {
            ...
            ids.QForEach<Polyline>(poly =>
            {
                ...
                var poly1 = DrawInMmemory.Pline(pts);
        ...
        public static void MT2DT() // newly 20130815
        {
            ...
            {
                var dt = DrawInMmemory.Text(mt.Text, mt.TextHeight, mt.Location, mt.Rotation, false, mt.TextStyleName);
                dt.Layer = mt.Layer;
                return dt;
            }).ToArray();
        ...
        public static void DT2MT() // newly 20130815
        {
            ...
            {
                var mt = DrawInMmemory.MText(dt.TextString, dt.Height, dt.Position, dt.Rotation, false);
                mt.Layer = dt.Layer;
                return mt;
            }).ToArray();
        ...
        public static void ShowExtents() // newly 20130815
        {
            ...
            var rectId = Drawing.Drawing.Rectang(extents.MinPoint, extents.MaxPoint);
        ...
        public static void PolyLanding()
        {
            ...
            while (true)
            {
                ...
                landingLineIds.Add(Drawing.Drawing.Line(p, landing));
            }
        ...
        public static void PolylineInfo() // mod by WY 20130202
        {
            ...
            {
                txtIds.Add(Drawing.Drawing.MText(i.ToString(), height, poly.GetPointAtParameter(i), 0, true));
            }
            Interaction.GetString("\nPress ENTER to exit");
        ...
        public static void ShowLayerName()
        {
            ...
            ids.QForEach<Entity>(entity =>
            {
                ...
                if (!layerName.Contains("_Label"))
                {
                    ...
                    var text = DrawInMmemory.MText(layerName, height, center, 0, true);
        ...
        {
            var bId = Drawing.Drawing.Block(QuickSelection.SelectAll(), "test");
        ...
        {
            var id = Interaction.GetEntity("\nEntity");
            Drawing.Drawing.Region(id);
            var point = Interaction.GetPoint("\nPick one point");
            Drawing.Drawing.Boundary(point, BoundaryType.Region);
        }
        ...
        {
            var lineId = Drawing.Drawing.Line(Point3d.Origin, Point3d.Origin + Vector3d.XAxis);
            lineId.SetLayer("aaa");
        }
        ...
        {
            Drawing.Drawing.Hatch(new[] { new Point3d(0, 0, 0), new Point3d(100, 0, 0), new Point3d(0, 100, 0) });
        }
        ...
        public void TestArc()
        {
            ...
            Drawing.Drawing.Circle(point1, 5);
            var point2 = Interaction.GetPoint("\nMid");
            Drawing.Drawing.Circle(point2, 5);
            var point3 = Interaction.GetPoint("\nEnd");
            Drawing.Drawing.Circle(point3, 5);
            Drawing.Drawing.Arc3P(point1, point2, point3);
        }
        ...
        public void TestArc2()
        {
            ...
            Drawing.Drawing.Circle(start, 5);
            var center = Interaction.GetPoint("\nCenter");
            Drawing.Drawing.Circle(center, 5);
            double angle = Interaction.GetValue("\nAngle");
            Drawing.Drawing.ArcSCA(start, center, angle);
        }
        ...
        public void TestEllipse()
        {
            ...
            Drawing.Drawing.Circle(endX, 5);
            double radiusY = Interaction.GetValue("\nRadius of another axis");
            Drawing.Drawing.Ellipse(center, endX, radiusY);
        }
        ...
        public void TestSpline()
        {
            ...
            while (true)
            {
                ...
                points.Add(point);
                Drawing.Drawing.Circle(point, 5);
            }
            Drawing.Drawing.SplineCV(points.ToArray(), true);
        }
        ...
        public void TestPolygon()
        {
            ...
            Drawing.Drawing.Circle(end, 5);
            Drawing.Drawing.Polygon(n, center, end);
        }
        ...
        public void ViewSpline()
        {
            ...
            knotPoints.ForEach(p => Drawing.Drawing.Circle(p, 5));
        }
        ...
        public void TestText()
        {
            ...
            Drawing.Drawing.Text("FontAbc", 100, Point3d.Origin, 0, true);
        }
        ...
        public void TestTable()
        {
            ...
            Drawing.Drawing.Table(Point3d.Origin, "Numbers", contents, 5, 20, 2.5);
        }
        ...
        public void TestMeasure()
        {
            ...
            Drawing.Drawing.Measure(cv, length, new DBPoint());
        }
        ...
        public void TestDivide()
        {
            ...
            Drawing.Drawing.Divide(cv, num, new DBPoint());
        }
        ...
        {
            var point = Interaction.GetPoint("\nPick one point");
            Drawing.Drawing.Boundary(point, BoundaryType.Polyline);
        }
        ...
        public void TestHatch3()
        {
            ...
            Drawing.Drawing.Hatch("SOLID", seed);
        }
        ...
        public void TestHatch4()
        {
            ...
            Drawing.Drawing.Hatch("SOLID", ents);
        }
        ...
        public void TestPolygonMesh()
        {
            ...
            Drawing.Drawing.PolygonMesh(points, m, n);
        }

        [CommandMethod("TestAddAttribute")]
        public void TestAppendAttribute()
        {
            var id = Drawing.Drawing.Insert("test", Point3d.Origin);
