...
namespace Intellidesk.AcadNet.Commands.Common
{
    ...
    public static class SymbolPack
    {
        public static ObjectId Arrow(Point3d end, Point3d head, ArrowOption opt)
        {
            ...
            var arrow = Drawing.Modify.Group(new[] { body });
        ...
        {
            var line1 = DrawInMmemory.Pline(p1, p2);
            ...
            var lines = Algorithms
                ...
                .Select(pos => DrawInMmemory.Pline(line1.GetPointAtDistX(pos), line2.GetPointAtDistX(pos)))
                .ToList();
            lines.Add(line1);
            lines.Add(line2);
    ...
    public class GraphPlotter
    {
        ...
        public ObjectId GetGraphBlock()
        {
            ...
            gridLines.QForEach<Entity>(line => line.ColorIndex = Option.GridColor);
            ...
            labels.QForEach<Entity>(mt => mt.ColorIndex = Option.LabelColor);
