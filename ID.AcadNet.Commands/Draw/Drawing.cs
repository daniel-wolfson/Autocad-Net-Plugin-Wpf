...
namespace Intellidesk.AcadNet.Commands.Drawing
{
    ...
    public static class Drawing
    {
        ...
        {
            return DrawInMmemory.Point(position).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Line(point1, point2).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Line(points).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Arc3P(point1, point2, point3).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.ArcSCA(start, center, angle).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.ArcFromGeometry(arc).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Pline(points).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Pline(points, globalWidth).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Pline(vertices, globalWidth).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.SplineFit(points).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.SplineCV(points, closed).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Rectang(point1, point2).AddToCurrentSpace();
        }
        ...
        public static ObjectId Polygon(int n, Point3d center, Point3d end)
        {
            ...
            var result = Drawing.Pline(points);
        ...
        {
            return DrawInMmemory.Circle(center, radius).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Circle(point1, point2).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Circle(point1, point2, point3).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Circle(circle).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.Ellipse(center, endX, radiusY).AddToCurrentSpace();
        }
        ...
        {
            var loop = Drawing.Boundary(seed, BoundaryType.Polyline);
            var result = Drawing.Hatch(new[] { loop }, hatchName);
        ...
        public static ObjectId Hatch(string hatchName, Entity[] entities)
        {
            ...
            // Step2 - draw
            return Drawing.Hatch(pointList, hatchName);
        }
        ...
        public static ObjectId Hatch(IEnumerable<Point3d> points, string hatchName = "SOLID", double scale = 1, double angle = 0)
        {
            ...
            var loop = Drawing.Pline(pts);
            var result = Drawing.Hatch(new[] { loop }, hatchName, scale, angle);
            loop.Erase();
            return result;
        }
        ...
        public static ObjectId Boundary(Point3d seed, BoundaryType type)
        {
            ...
            if (loop.Count > 0)
            {
                if (type == BoundaryType.Polyline)
                {
                    ...
                    return Drawing.AddToCurrentSpace(poly);
                }
                else // type == BoundaryType.Region
                {
                    ...
                    if (region.Count > 0)
                    {
                        return Drawing.AddToCurrentSpace(region[0] as Region);
                    }
                }
            }
        ...
        {
            return DrawInMmemory.Text(text, height, position, rotation, centerAligned, textStyle).AddToCurrentSpace();
        }
        ...
        {
            return DrawInMmemory.MText(text, height, position, rotation, centerAligned, width).AddToCurrentSpace();
        }
        ...
        public static ObjectId Wipeout(params Point3d[] points)
        {
            ...
            var result = Drawing.AddToCurrentSpace(wipe);
        ...
        public static ObjectId Wipeout(Extents3d extents)
        {
            ...
            return Drawing.Wipeout(extents.MinPoint, a, extents.MaxPoint, b, extents.MinPoint);
        }
        ...
        {
            Drawing.Block(entities, blockName, blockBasePoint, overwrite);
            return Drawing.Insert(blockName, insertPosition, rotation, scale);
        }
        ...
        public static ObjectId Table(Point3d position, string title, List<List<string>> contents, double rowHeight, double columnWidth, double textHeight, string textStyle = Consts.TextStyleName)
        {
            ...
            return Drawing.AddToCurrentSpace(tb);
        }
        ...
        public static ObjectId Dimlin(Point3d start, Point3d end, Point3d dim)
        {
            ...
            return Drawing.AddToCurrentSpace(ad);
        }
