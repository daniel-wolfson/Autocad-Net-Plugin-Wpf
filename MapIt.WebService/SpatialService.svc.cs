...
namespace MapIt.WebService
{
    ...
    public class SpatialService : ISpatialService
    {
        ...
        public Common.Response FindNearBy(double latitude, double longitude, double radius, string layerName)
        {
            Common.Response r = new Common.Response();
        ...
        public Common.Response FindInPolygon(string polygonWKT, string layerName)
        {
            Common.Response r = new Common.Response();
        ...
        public Common.Response FindByBoundingBox(double north, double east, double south, double west, string layerName)
        {
        ...
        public Common.Response FindNearRoute(string waypoints, double radius, string bingMapsKey, string layerName)
        {
            ...
            try
            {
                ...
                Route route = (Route)r.ResourceSets[0].Resources[0];
