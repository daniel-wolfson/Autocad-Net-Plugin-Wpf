...
namespace Intellidesk.AcadNet.Helpers
{
    ...
    /// </summary>
    public partial class ImageAnim : UserControl
    {
        ...
        public static readonly DependencyProperty ForceGifAnimProperty =
            DependencyProperty.Register("ForceGifAnim", typeof(bool),
                typeof(ImageAnim), new FrameworkPropertyMetadata(false));
        ...
        public static readonly DependencyProperty StretchDirectionProperty 
            = DependencyProperty.Register("StretchDirection", typeof(StretchDirection), typeof(ImageAnim), new FrameworkPropertyMetadata(StretchDirection.Both, FrameworkPropertyMetadataOptions.AffectsMeasure, new PropertyChangedCallback(OnStretchDirectionChanged)));
