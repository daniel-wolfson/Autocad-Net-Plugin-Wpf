...
{
    public partial class ClosurePanelView : IPanelTabView
    {
        public Common.Enums.PaletteNames PanelTabName => Common.Enums.PaletteNames.Closure;
        public class ClosureEnumValueConverter : EnumValueConverter<eClosureType> { }
        public IClosurePanelContext PanelDataContext { get; }

        #region <ctor>

        public ClosurePanelView(Func<IClosurePanelContext> getDataContext) //
        {
            ...
            Loaded += (obj, e) =>
            {
                ...
                //ClosurePanelDataContext.LoadEvents();
            };
        }
