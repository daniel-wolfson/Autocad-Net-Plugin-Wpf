...
namespace Intellidesk.AcadNet.Views
{
    ...
    public partial class QueryLayersPanelView : IPanelTabView
    {
        public PaletteNames PanelTabName => PaletteNames.BayQueries;
        public ILayerQueriesPanelContext PanelDataContext { get; }

        #region <ctor>

        public QueryLayersPanelView(Func<ILayerQueriesPanelContext> getDataContext)
        {
