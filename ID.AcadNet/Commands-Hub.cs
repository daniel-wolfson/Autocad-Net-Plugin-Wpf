...
[assembly: CommandClass(typeof(Intellidesk.AcadNet.CommandHub))]
...
namespace Intellidesk.AcadNet
{
    public class CommandHub
    {
        ...
        private static void SendMessageToSignalRServer(string cmdName, string dwgFileName)
        {
            ...
            //AcadCommandTrack atrck = new AcadCommandTrack()
            //    {
            //        UserName = user,
            ...
            ////Call the hub method "RelayAcadMessage()" on SignalR server side
            //_hubProxy.Invoke<AcadCommandTrack>("RelayAcadMessage", atrck);
        }
