...
namespace ID.Infrastructure
{
    ...
    public class DelegateCommand : ICommand
    {
        ...
        public DelegateCommand(Action<object> executeMethod, Func<bool> canExecuteMethod, Func<bool> callback)
            : this(executeMethod, canExecuteMethod, false, callback)
        {
        }

        /// <summary> Constructor </summary>
        public DelegateCommand(Action<object> executeMethod, Func<bool> canExecuteMethod,
            bool isAutomaticRequeryDisabled, Func<bool> callback = null)
        {
    ...
    public class CustomDelegateCommand<T> : ICommand
    {
