...
namespace Intellidesk.AcadNet.Tools.Constructions
{
	...
	public class Column : Construction, ICntTabPalette, ICntTreeViewData
	{
		...
		private  _BorderColor = Drawing.Color.Red;
		...
		[TypeConverter(typeof(Converters.PlacementStyle360Converter))]
		[EditorAttribute(typeof(TestDropDownEditor), typeof(UITypeEditor))]
		public override int Placement {
			get {
				TestDropDownEditor.PenColor = BorderColor;
				return _Placement;
			}
			set { _Placement = value; }
		}
		//Public Overrides Property Placement() As Integer
		...
		//point 2
		//<DisplayName("Size"), DefaultValueAttribute("0,0"), DescriptionAttribute("Size")> _
		//Public Overrides Property Size() As Drawing.Size  'Size
		...
		public override List<Drawing.Point> SelectedPoints {
			...
			set {
				...
				if (value != null) {
					...
					this.Refresh();
					//Me.Size = New Drawing.Size(pnt1.X - pnt2.X, pnt1.Y - pnt2.Y)
					//Building.Floors(Me.FloorId).Constructions(Me.CntId) = Me
					//CType(Me.PalleteControl, CntDetailControl).pGrid.SelectedObject = Me
					//CType(Me.PalleteControl, CntDetailControl).pGrid.Refresh()
