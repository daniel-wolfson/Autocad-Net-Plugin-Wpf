...
namespace Intellidesk.AcadNet.Tools.Constructions
{
	...
	public class Plate : Construction, ICntTabPalette, ICntTreeViewData, ICloneable
	{
		...
		#endregion
		//Private dm As DataConstruction = New DataConstruction("CntDat.xml")
