...
-- --------------------------------------------------
-- Date Created: 12/16/2014 22:59:28
-- Generated from EDMX file: C:\Projects\AcadNet\AcadNet.Data\Models\MapInfoModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[HouseNum]', 'U') IS NOT NULL
    DROP TABLE [dbo].[HouseNum];
GO
IF OBJECT_ID(N'[dbo].[Layers]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Layers];
GO
IF OBJECT_ID(N'[dbo].[Street]', 'U') IS NOT NULL
