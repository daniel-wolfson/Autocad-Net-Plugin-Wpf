...
namespace Intellidesk.Data.Repositories.EF6.Factories
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        ///     </p>
        /// </remarks>
        protected Dictionary<Type, dynamic> Repositories { get; set; }

        /// <summary>
        ///     Get and set the <see cref="Intellidesk.AcadNet.Data.Repositories.Intellidesk.AcadNet.Data.Repositories.EF6.DataContexttory if one must be created.
        /// </summary>
        ...
        public IXmlRepositoryAsync<T> GetXmlRepositoryForEntityType<T>() where T : class, IObjectState
        {
            return GetRepository<IXmlRepositoryAsync<T>>(_repositoryFactories.GetRepositoryFactoryForEntityType<T>());
        }

        public IJsonRepositoryAsync<T> GetJsonRepositoryForEntityType<T>() where T : class, IObjectState
        {
            return GetRepository<IJsonRepositoryAsync<T>>(_repositoryFactories.GetRepositoryFactoryForEntityType<T>());
        }
        ...
        ///     The <see cref="Intellidesk.AcadNet.Data.Repositories.Intellidesk.AcadNet.Data.Repositories.EF6.DataContextsitory.
        /// </param>
        /// <param name="factory">
        ///     Factory with <see cref="Intellidesk.AcadNet.Data.Repositories.Intellidesk.AcadNet.Data.Repositories.EF6.DataContexttory.
