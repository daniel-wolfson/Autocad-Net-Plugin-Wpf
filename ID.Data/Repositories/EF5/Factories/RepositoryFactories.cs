...
namespace AcadNet.Data.Repositories.Ef5.Factories
{
    /// <summary>
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private readonly IDictionary<Type, Func<IDataContext, IUnitOfWork, dynamic>> _repositoryFactories;
        ...
        /// </remarks>
        private IDictionary<Type, Func<IDataContext, IUnitOfWork, dynamic>> GetFactories()
        {
            return new Dictionary<Type, Func<IDataContext, IUnitOfWork, dynamic>>();
        }
        ...
        /// </remarks>
        public Func<IDataContext, IUnitOfWork, dynamic> GetRepositoryFactory<T>()
        {
            Func<IDataContext, IUnitOfWork, dynamic> factory;
        ...
        /// </remarks>
        public Func<IDataContext, IUnitOfWork, dynamic> GetRepositoryFactoryForEntityType<T>() where T : class, IObjectState
        {
        ...
        protected virtual Func<IDataContext, IUnitOfWork, dynamic> DefaultEntityRepositoryFactory<T>() where T : class, IObjectState
        {
