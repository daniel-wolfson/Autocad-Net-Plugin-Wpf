...
namespace AcadNet.Data.Repositories.Ef5.Factories
{
    ...
    public class RepositoryProvider : IRepositoryProvider
    {
        ...
        /// </remarks>
        public IRepository<T> GetRepositoryForEntityType<T>() where T : class, IObjectState
        {
        ...
        /// </remarks>
        public virtual T GetRepository<T>(Func<IDataContext, IUnitOfWork, dynamic> factory = null) where T : class
        {
        ...
        /// </param>
        /// <returns></returns>
        protected virtual T MakeRepository<T>(Func<IDataContext, IUnitOfWork, dynamic> factory, IDataContext dbContext, IUnitOfWork unitOfWork)
        {
            ...
            var repository = repositoryFactory(dbContext, unitOfWork);
            Repositories[typeof (T)] = repository;
