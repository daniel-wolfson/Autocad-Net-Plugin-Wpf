...
namespace AcadNet.Data.Repositories.Ef5.Factories
{
    ...
    public interface IRepositoryProvider
    {
        ...
        /// </typeparam>
        IRepository<T> GetRepositoryForEntityType<T>() where T : class, IObjectState;
        ...
        /// </remarks>
        T GetRepository<T>(Func<IDataContext, IUnitOfWork, dynamic> factory = null) where T : class;
