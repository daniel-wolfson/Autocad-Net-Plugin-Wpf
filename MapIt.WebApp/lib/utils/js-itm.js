 ...
 *
 * @constructor
 * @param {Number} Latitude latitude in degrees ( http://en.wikipedia.org/wiki/Latitude )
 * @param {Number} Longitude longtitude in degrees ( http://en.wikipedia.org/wiki/Longitude )
