(function (factory) {
    ...
    L.Control.Search = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            this._dropdown = this._createDropDown('search-dropdown', this);
        ...
        _createDropDown: function (className) {
            ...
            var controlAngular = L.control.angular({
                position: 'topleft',
                template: ['<span class="input-group-btn search-dropdown" >', //ng-controller="searchController"
                  ...
                  '<span>{{selectedItem.name}}</span><span class="caret"></span>',
                  '</button></a>',
                  '<ul class="dropdown-menu" aria-labelledby="markerTypeDropdownMenu">',
                  '<li ng-repeat="markerFilter in markerFilters"><a class="dropdownitem" ng-click="dropboxitemselected(markerFilter)">{{markerFilter.name}}</a></li>',
                  '<li role="separator" class="divider"></li>',
                  '<li><a id="filterCmb" href="#" ng-click="dropboxitemselected()">Adress</a></li>',
                  '</ul></span>'
                ].join(""),
            ...
            var dropDown = L.DomUtil.create('div', className, this._container);
            dropDown.style.display = 'none';//dropDown.innerHTML = $(controlAngular)[0].outerHTML;
            dropDown.appendChild(controlAngular.getContainer());
            ...
            //$(dropDown).find(".dropdownitem").addEventListener("click", function () {
            //    var a = 1;
            //}, false);
            return dropDown;
        },
