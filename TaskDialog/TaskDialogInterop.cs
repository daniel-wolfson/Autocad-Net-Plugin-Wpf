...
namespace TaskDialogInterop
{
	...
	public enum VistaTaskDialogIcon : uint
	{
        ...
        /// <summary>
        /// Security Shield (Blue) icon.
        /// </summary>
        SecurityShieldBlue = 0xFFFB, //UInt16.MaxValue - 4
        /// <summary>
        /// Security Warning icon.
        /// </summary>
        SecurityWarning = 0xFFFA, //UInt16.MaxValue - 5
        /// <summary>
        /// Security Error icon.
        /// </summary>
        SecurityError = 0xFFF9, //UInt16.MaxValue - 6
        /// <summary>
        /// Security Success icon.
        /// </summary>
        SecuritySuccess = 0xFFF8, //UInt16.MaxValue - 7
        /// <summary>
        /// Security Shield Gray icon.
        /// </summary>
        SecurityShieldGray = 0xFFF7, //UInt16.MaxValue - 8
    }
  ...
  public struct VistaTaskDialogButton
  {
	...
	public class VistaTaskDialog
	{
		...
		private int PrivateShow(IntPtr hwndOwner, out bool verificationFlagChecked, out int radioButtonResult)
		{
			...
			radioButtonResult = 0;
			int result = 0;
			var config = new VistaUnsafeNativeMethods.TASKDIALOGCONFIG();
		...
		private int PrivateCallback([In] IntPtr hwnd, [In] uint msg, [In] UIntPtr wparam, [In] IntPtr lparam, [In] IntPtr refData)
		{
			...
			if (callback != null)
			{
				...
				var activeDialog = new VistaActiveTaskDialog(hwnd);
