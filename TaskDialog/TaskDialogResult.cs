...
namespace TaskDialogInterop
{
	...
	public class TaskDialogResult
	{
		...
		/// </summary>
		public TaskDialogSimpleResult Result { get; set; }
		/// <summary>
		...
		/// </summary>
		public int? RadioButtonResult { get; set; }
		/// <summary>
